...
def load_sentences_local() -> list:
    ...
    sentences = [
        {"text": "When my time comes. Forget the wrong that I’ve done.", "level": 2},
        {"text": "In a hole in the ground there lived a hobbit.", "level": 3},
        {
        ...
        {"text": "The Consul watched as Kassad raised the death wand.", "level": 2},
        {"text": "If you want to make enemies, try to change something.", "level": 3},
        {
...
def load_sentences_remote(user_word: str) -> list:
    ...
    response = requests.get(
        f"https://sentence.yourdictionary.com/{user_word}", timeout=5
    )
